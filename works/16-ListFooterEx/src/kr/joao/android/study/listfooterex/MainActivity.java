package kr.joao.android.study.listfooterex;
...
public class MainActivity extends ActionBarActivity implements OnItemClickListener, OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listFooter = (ListView) findViewById(R.layout.list_footer);
		
		ListView listView1 = (ListView) findViewById(R.id.listView1);
		
		listView1.addFooterView(listFooter);
